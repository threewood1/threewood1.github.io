...
{	
	...
	if (firstIndex <= 0) window.location.href="currentUrl" + "#contact"; $('#music2').attr('src', bgmsrc); document.addeventlistener('touchstart',function (event) { if(event.touches.length> 1) event.preventDefault(); });
